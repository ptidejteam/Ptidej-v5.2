	...
	protected void setUp()
		...
		if (Composition2.BuiltSolutions == null) {
			Composition2.BuiltSolutions =
				Composition2.automaticSolve(
					ptidej.solver.test.data.problem.fingerprint.CompositionTest2.class,
					ptidej.solver.test.data.source.CompositionTest.class);
		}
	}
	public void testNumberOfSolutions() {
		Composition2.assertEquals(
			"Number of solutions",
			1,
	...
	public void testSolutionPercentage() {
		for (int i = 0; i < Composition2.BuiltSolutions.length; i++) {
			Composition2.assertEquals(
				...
				100,
				Composition2.BuiltSolutions[i].getPercentage());
		}
	}
}
