...
import ptidej.solver.constraint.CompositionConstraint;
import ptidej.solver.constraint.NotEqualConstraint;
...
public final class CompositionTest {
	public static Problem getProblem(final List allEntities) {
		...
		final Variable aggregate =
			new Variable(pb, "Aggregate", true, aggregateList);
		final Variable aggregated =
			new Variable(pb, "Aggregated", true, aggregatedList);
