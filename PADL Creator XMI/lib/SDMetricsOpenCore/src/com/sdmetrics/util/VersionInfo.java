...
public class VersionInfo {
	...
	public final static String VERSION_NUMBER = "V2.31";
	/** Program name+version. */
	public final static String VERSION = "SDMetrics " + VERSION_NUMBER;
	/** Copyright string, using unicode characters. */
	public final static String COPYRIGHT = "\u00a9 2002-2013 by J\u00FCrgen W\u00FCst";
	/** Copyright string, using only ASCII characters. */
	public final static String COPYRIGHTASCII = "(c) 2002-2013 by Juergen Wuest";
}
