...
{
    Ogre::Bone * pBone = GET_PTR(Ogre::Bone, pInstance);
    return pBone->getHandle();
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
JNIEXPORT void JNICALL Java_org_ogre4j_Bone_setManuallyControlled
  (JNIEnv *env, jclass that, jint pInstance, jboolean jbManuallyControlled )
{
    Ogre::Bone * pBone = GET_PTR(Ogre::Bone, pInstance);
    pBone->setManuallyControlled( jbManuallyControlled?true:false );
}
...
{
    Ogre::Bone * pBone = GET_PTR(Ogre::Bone, pInstance);
    return pBone->isManuallyControlled();
}