...
public class DataDiffSnapshooterExtender
...
{
diff = this.getExtendedSnapshooter().getSnapshot(i).dataDiff(this.getExtendedSnapshooter().getSnapshot(diffList.getLast()));
if(diff.isDiff()) 
{
diffList.addLast(i);
