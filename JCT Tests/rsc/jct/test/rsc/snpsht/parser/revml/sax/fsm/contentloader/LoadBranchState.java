...
{
this.getManager().setBranch(loadedString, this.getFile());

}

public java.lang.String toString()
{
java.lang.String toRet = "<LoadBranchState>
Branch: " + this.getLoadedString();
return toRet;
...
{
return jct.test.rsc.snpsht.parser.revml.RevMLDocCommonsStrings.FILE_REV_BRANCH_MARKER;
