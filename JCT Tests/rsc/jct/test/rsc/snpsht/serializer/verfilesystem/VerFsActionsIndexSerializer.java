...
public class VerFsActionsIndexSerializer
...
{
jct.test.rsc.snpsht.filesystem.IFsFileEntity entity = this.manager.getSourceManager().add(jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTIONS_INDEX_XML_FILE_NAME);
...
{
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTIONS_MAKER + ">");

{
for(jct.test.rsc.snpsht.verfilesystem.flag.action.IVerFsAction action : this.manager.getAllActions()) 
{
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTION_MAKER + " " + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTION_TYPE_ATTRIBUTE + "=\"" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ASCII2XML(action.getValue()) + "\">");

{
writer.write(this.genMarker(jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTION_TYPE_MAKER, jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ASCII2XML(action.getValue())));
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.REVISIONS_MAKER + ">");

{
jct.test.rsc.snpsht.verfilesystem.VerFsFileRev[] files = action.getChildren().toArray(new jct.test.rsc.snpsht.verfilesystem.VerFsFileRev[0]);
...
writer.write("</" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ACTION_MAKER + ">");
