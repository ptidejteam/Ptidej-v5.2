...
public class VerFsTagsIndexSerializer
...
{
jct.test.rsc.snpsht.filesystem.IFsFileEntity entity = this.manager.getSourceManager().add(jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAGS_INDEX_XML_FILE_NAME);
...
{
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAGS_MAKER + ">");

{
for(jct.test.rsc.snpsht.verfilesystem.flag.IVerFsTag tag : this.manager.getAllTags()) 
{
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAG_MAKER + " " + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAG_ID_ATTRIBUTE + "=\"" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ASCII2XML(tag.getValue()) + "\">");

{
writer.write(this.genMarker(jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAG_ID_MAKER, jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.ASCII2XML(tag.getValue())));
writer.write("<" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.REVISIONS_MAKER + ">");

{
jct.test.rsc.snpsht.verfilesystem.VerFsFileRev[] files = tag.getChildren().toArray(new jct.test.rsc.snpsht.verfilesystem.VerFsFileRev[0]);
...
writer.write("</" + jct.test.rsc.snpsht.serializer.verfilesystem.VerFsCommonStrings.TAG_MAKER + ">");
