...
public class Composite1FromClassFiles extends TestCase {
	...
	protected void setUp() throws IllegalAccessException,
		...
		if (Composite1FromClassFiles.FoundSolutions == null) {
			...
			try {
				...
				final IIdiomLevelModel idiomLevelModel =
					ModelGenerator
						.generateModelFromClassFilesDirectories(new String[] { "../Ptidej Tests/bin/ptidej/example/composite1/" });

				// Expected solutions.
				Composite1FromClassFiles.ExpectedSolutions =
	...
	public void testSolutions() {
		for (int i = 0; i < Composite1FromClassFiles.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals(
				"",
